...
<span style="color:#bfa530">Vreg output: <span className="bp-float">4.9</span></span>V<span style="color:#bfa530">, Vref/Vout pin: <span className="bp-float">4.9</span></span>V<span style="color:#bfa530">, Current: <span className="bp-float">3.4</span></span>mA<span style="color:#bfa530">
</span>
<span style="color:#96cb59">I2C></span> 
{{% /term %}}
...
I2C START
<span style="color:#bfa530">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">09</span> ACK 0x<span className="bp-float">12</span> ACK 
I2C STOP
<span style="color:#96cb59">I2C></span> 
{{% /term %}}
...
I2C START
<span style="color:#bfa530">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">09</span> ACK 
I2C STOP
<span style="color:#96cb59">I2C></span>
{{% /term %}}
...
<span style="color:#bfa530">RX:</span> 0x<span className="bp-float">12</span> NACK 
I2C STOP
<span style="color:#96cb59">I2C></span> 
{{% /term %}}
...
I2C START
<span style="color:#bfa530">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">00</span> ACK 
I2C STOP
<span style="color:#96cb59">I2C></span>
{{% /term %}}
