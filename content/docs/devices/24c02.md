...
...
 5. <span className="bp-info">I2C</span>
...
...
<span className="bp-info">I2C speed</span>
 1kHz to 1000kHz
 x. <span className="bp-info">Exit</span>
<span className="bp-prompt">kHz (</span>400kHz*<span className="bp-prompt">) ></span> 100
...
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> W 5
...
<span className="bp-info">Vreg output: <span className="bp-float">4.9</span></span>V<span className="bp-info">, Vref/Vout pin: <span className="bp-float">4.9</span></span>V<span className="bp-info">, Current: <span className="bp-float">3.4</span></span>mA<span className="bp-info">
</span>
<span className="bp-prompt">I2C></span> 
{{% /term %}}
...
### Write Byte
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa0 0x09 0x12]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">09</span> ACK 0x<span className="bp-float">12</span> ACK 
I2C STOP
<span className="bp-prompt">I2C></span> 
{{% /term %}}
...
#### Set address pointer
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa0 0x9]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">09</span> ACK 
I2C STOP
<span className="bp-prompt">I2C></span>
{{% /term %}}
...
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa1 r]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A1</span> ACK 
<span className="bp-info">RX:</span> 0x<span className="bp-float">12</span> NACK 
I2C STOP
<span className="bp-prompt">I2C></span> 
{{% /term %}}
...
### Write Page
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa0 0x00 0x12 0x34 0x  0x56 0x78 0x9a 0xbc 0xde 0xf0]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">00</span> ACK 0x<span className="bp-float">12</span> ACK 0x<span className="bp-float">34</span> ACK 0x<span className="bp-float">56</span> ACK 0x<span className="bp-float">78</span> ACK 0x<span className="bp-float">9A</span> ACK 0x<span className="bp-float">BC</span> ACK 
    0x<span className="bp-float">DE</span> ACK 0x<span className="bp-float">F0</span> ACK 
I2C STOP
<span className="bp-prompt">I2C></span>
{{% /term %}}
...
#### Set address pointer
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa0 0x00]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A0</span> ACK 0x<span className="bp-float">00</span> ACK 
I2C STOP
<span className="bp-prompt">I2C></span>
{{% /term %}}
...
{{% term "Bus Pirate [/dev/ttyS0]" %}}
<span className="bp-prompt">I2C></span> [0xa1 r:256]

I2C START
<span className="bp-info">TX:</span> 0x<span className="bp-float">A1</span> ACK 
<span className="bp-info">RX:</span> 0x<span className="bp-float">12</span> ACK 0x<span className="bp-float">34</span> ACK 0x<span className="bp-float">56</span> ACK 0x<span className="bp-float">78</span> ACK 0x<span className="bp-float">9A</span> ACK 0x<span className="bp-float">BC</span> ACK 0x<span className="bp-float">DE</span> ACK 0x<span className="bp-float">F0</span> ACK
...lines removed....
0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> ACK 0x<span className="bp-float">FF</span> NACK 
